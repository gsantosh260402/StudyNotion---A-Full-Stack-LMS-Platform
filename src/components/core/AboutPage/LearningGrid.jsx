...
const LearningGrid = () => {
  return (
    <div className="grid mx-auto grid-cols-1 lg:grid-cols-4 mb-10 p-4">
        ...
        return (
          <div 
            ...
            className={`${index === 0 && "lg:col-span-2 lg:h-[250px]"}
               ${
                   card.order >= 0 ? (card.order % 2 === 1 ? "bg-richblack-700 lg:h-[250px]" : "bg-richblack-800 lg:h-[250px]") : ""
               }
               ${ card.order === 3 && "lg:col-start-2"}
            `}>
            {card.order < 0 ? (
              <div className="lg:w-[90%] flex flex-col pb-5 gap-3 bg-none">
              ...
              <div className="flex flex-col p-7 gap-8">
                ...
                <p className="text-sm text-richblack-25">{card.description}</p>
              </div>
            )}
          </div>
        );
