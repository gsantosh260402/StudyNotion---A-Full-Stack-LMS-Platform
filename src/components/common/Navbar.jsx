...
import { fetchAllCategories } from '../../services/operations/CategoryAPI'
...
const Navbar = () => {
    ...
    const getCategoryLink = (text) => text.split(" ").join("-").toLowerCase();
...

                                {
                                    categories.length ? (
                                            categories.map( (category, index) => (
                                                ...
                                                <Link to={`/catalog/${getCategoryLink(category.name)}`} key={index}>
                                                    <p>{category.name}</p>
                                                </Link>
                                            ) )
